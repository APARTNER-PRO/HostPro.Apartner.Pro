  ...
  en: {
      ...
      categories: [
        {
          name: 'CMS Hosting',
          items: [
            { slug: 'wordpress-hosting', name: 'WordPress Hosting', seo: { title: 'Optimized WordPress Hosting', text: 'Our WordPress hosting is fine-tuned for the best performance and security. With LiteSpeed Cache and NVMe SSDs, your blog or business site will load instantly, improving your SEO and user experience.' } },
            { slug: 'joomla-hosting', name: 'Joomla Hosting', seo: { title: 'Professional Joomla Hosting Solutions', text: 'Joomla requires a stable and powerful environment. We provide optimized server configurations specifically for Joomla sites, ensuring high security and fast database response times.' } },
            { slug: 'prestashop-hosting', name: 'Prestashop Hosting', seo: { title: 'Fast Hosting for PrestaShop Stores', text: 'E-commerce sites need speed to convert visitors into customers. Our PrestaShop hosting includes advanced caching and specialized security to protect your online business.' } },
            { slug: 'drupal-hosting', name: 'Drupal Hosting', seo: { title: 'Enterprise-Grade Drupal Hosting', text: 'Drupal is powerful but resource-intensive. Our infrastructure provides the necessary RAM and CPU power to handle complex Drupal projects with ease.' } },
            { slug: 'magento-hosting', name: 'Magento Hosting', seo: { title: 'High-Performance Magento Hosting', text: 'Magento is the choice for large online stores. We offer dedicated resources and Varnish caching to ensure your Magento store stays fast under heavy load.' } },
            { slug: 'opencart-hosting', name: 'OpenCart Hosting', seo: { title: 'Reliable Hosting for OpenCart', text: 'Simple to manage, fast to load. Our OpenCart hosting plan is designed for small to medium businesses that want a stable online store without technical headaches.' } },
            { slug: 'charity-hosting', name: 'Charity Hosting', seo: { title: 'Supporting Non-Profits with Reliable Hosting', text: 'We believe in giving back. Our charity hosting provides non-profit organizations with a stable platform to spread their message and manage their initiatives effectively.' } },
          ]
        },
        {
          name: 'Shared Hosting',
          items: [
            { slug: 'cloud-hosting', name: 'Cloud Hosting', seo: { title: 'Scalable Cloud Hosting Services', text: 'Cloud hosting provides unparalleled reliability. Your site is hosted on a cluster of servers, meaning no single point of failure and instant scaling options.' } },
            { slug: 'vip-hosting', name: 'VIP Hosting', seo: { title: 'Exclusive VIP Hosting Experience', text: 'For those who need more than regular shared hosting. VIP hosting offers more resources, priority support, and a less crowded server environment.' } },
            { slug: 'hosting-with-domain', name: 'Hosting with Domain', seo: { title: 'All-in-One Hosting and Domain Package', text: 'Start your online journey easily. Register your domain and get high-quality hosting in one bundle, managed from a single professional dashboard.' } },
            { slug: 'student-hosting', name: 'Affordable Hosting for Students', text: 'Learning web development? Our student hosting plan is priced for a budget while providing all the tools you need to build and test your first projects.' },
            { slug: 'reseller-hosting', name: 'Powerful Reseller Hosting', seo: { title: 'Start Your Own Hosting Business', text: 'Our reseller hosting gives you the power to sell hosting to your own clients. Manage multiple accounts easily with WHM and provide premium service under your brand.' } },
            { slug: 'overseas-hosting', name: 'Global Overseas Hosting', seo: { title: 'Host Your Site Closer to Your Audience', text: 'Reach international markets with our overseas hosting. Low latency and high-speed connections to global backbones ensure a smooth experience for worldwide users.' } },
            { slug: 'ssd-hosting', name: 'Fast SSD-Powered Hosting', seo: { title: 'Boost Speed with Pure SSD Storage', text: 'Old HDDs are history. Our SSD hosting ensures that your website files and databases are served at lightning speed, significantly reducing load times.' } },
            { slug: 'trial-hosting', name: 'Risk-Free Hosting with Trial Period', seo: { title: 'Try Our Hosting Before You Buy', text: 'Confidence in our quality allows us to offer a trial period. Test our speed, support, and control panel features for free before making a commitment.' } },
            { slug: 'blog-hosting', name: 'Dedicated Blog Hosting', seo: { title: 'Share Your Story with Reliable Hosting', text: 'Whether you use WordPress, Ghost, or a static site, our blog hosting provides the stability you need to grow your audience and share your content.' } },
            { slug: 'forum-hosting', name: 'Stable Forum Hosting', seo: { title: 'Build Your Community on Fast Servers', text: 'Forums generate a lot of database queries. Our hosting is optimized for software like phpBB or vBulletin, ensuring smooth interaction for your members.' } },
            { slug: 'landing-page-hosting', name: 'High-Converting Landing Page Hosting', seo: { title: 'Fast Hosting for Your Marketing Campaigns', text: 'Every second counts for conversions. Our landing page hosting ensures that your marketing pages load instantly, maximizing your ROI.' } },
            { slug: 'ecommerce-hosting', name: 'Hosting for Online Store' },
            { slug: 'business-card-hosting', name: 'Hosting for Business Card Site', seo: { title: 'Fast Hosting for Business Card Sites', text: 'A business card site is your face on the internet. We provide reliable hosting that ensures instant loading of your contact information and portfolio, helping you make a professional impression.' } },
            { slug: 'email-hosting', name: 'Email Hosting', seo: { title: 'Professional Corporate Email Hosting', text: 'Create professional mailboxes on your domain. Our email hosting provides high deliverability, spam protection, and convenient access via any device.' } },
            { slug: 'nvme-hosting', name: 'NVMe Hosting', seo: { title: 'Ultra-Fast NVMe SSD Hosting', text: 'Unlock the full potential of your site with NVMe drives. Speed up database performance and file access by 3-5 times compared to regular SSDs.' } },
          ]
        },
        {
          name: 'Free Hosting',
          items: [
            { slug: 'free-php-hosting', name: 'Free PHP Hosting', seo: { title: 'Reliable Free PHP Hosting', text: 'Perfect start for PHP developers. Get all the necessary features including MySQL and cPanel for free to test and launch your scripts.' } },
            { slug: 'free-personal-hosting', name: 'Free Personal Hosting', seo: { title: 'Free Hosting for Personal Projects', text: 'Launch your blog or personal site without costs. We provide stable infrastructure and 24/7 monitoring even for free plans.' } },
            { slug: 'free-wordpress-hosting', name: 'Free WordPress Hosting', seo: { title: 'Optimized Free WordPress Hosting', text: 'The easiest way to start with WordPress. Pre-configured environment, one-click installation, and modern NVMe storage at zero cost.' } },
            { slug: 'partner-free-hosting', name: 'Partner Free Hosting', seo: { title: 'Free Hosting for Partners', text: 'Are you an agency or developer? Bring clients to HostPro and get free high-performance hosting for your own projects as a reward.' } },
          ]
        }
      ]
    },
    ...
    tech: {
      ...
      server: {
        ...
        items: [
          { title: 'LiteSpeed Web Server', desc: 'Significantly faster than Apache, optimized for WordPress, PrestaShop, OpenCart, WooCommerce, Laravel, and more.' },
      ...
      email: {
        ...
        items: [
          { title: 'Professional Email', desc: 'Create boxes on your own domain (info@yourdomain.com).' },
          { title: 'Spam Protection', desc: 'Powerful SpamExperts and SpamAssassin tools included.' },
          { title: 'Webmail / IMAP / POP3', desc: 'Access mail via browser or your favorite mail clients.' },
        ],
      },
      dev: {
    ...
    pricing: {
      ...
      plans: [
        ...
        {
          name: 'Agency', desc: 'For online stores and business agencies', price: 19.99, color: '#FB923C', popular: true,
          extras: [
        ...
        {
          name: 'Agency Pro', desc: 'For successful large-scale projects and powerful teams', price: 39.99, color: '#F472B6', popular: false,
          extras: [
      ...
      faq: [
        { q: "Can I upgrade my plan later?", a: "Yes. You can change your plan at any time without any downtime — you only pay the difference in cost." },
        { q: "Do you help with website migration?", a: "Yes. We will migrate your site from another host for free with any hosting plan — just contact us after payment." },
        { q: "How fast is hosting activated?", a: "Hosting is activated instantly after payment. You will receive access details for the control panel via email immediately." },
        { q: "Are there any hidden fees?", a: "No. The prices on the site are final: SSL certificate, backups, and malware protection are already included in the cost." },
        { q: "Is there a money-back guarantee?", a: "Yes. We offer a 14-day money-back guarantee if the service doesn't suit you." },
        { q: "What is cPanel and is it easy to use?", a: "cPanel is the world's most popular hosting control panel. It has a simple interface, so even a beginner can manage a website." },
        { q: "Where are your servers located?", a: "Our servers are located in a modern data center in Warsaw (Poland). This ensures low latency and high loading speed for users from Ukraine, Poland, Romania, Moldova, Hungary, Slovakia, Czech Republic, Baltic states (Latvia, Lithuania, Estonia), Northern Europe (Finland), as well as Germany, Italy, Turkey, Kazakhstan, Uzbekistan, and other countries in Europe and Central Asia. Data is stored within the EU, which is important for business and compliance with European data protection requirements." },
      ],
    },
    ...
    freeHosting: {
      meta: 'Free hosting for partners — share your link, bring clients and get free hosting for your website.',
      badge: '🎁 Partner Program · Free Hosting',
      title1: 'Free hosting for',
      title2: 'our partners',
      sub: 'Sign up, get a unique link and attract clients. The reward is free hosting for your website, and click statistics are available in the system.',
      ...
      terms: [
        'You must apply and get a referral link to participate.',
        'The client must purchase hosting via your link for at least 1 year.',
        'Click and purchase statistics are available in your partner system.',
      ...
      form: {
        ...
        notes: 'Where do you plan to promote the link? (optional)',
        submit: 'Send Application →',
        success: '✅ Application sent! We will contact you soon to provide your link.',
  ...
  uk: {
      ...
      categories: [
        {
          name: 'CMS-хостинг',
          items: [
            { slug: 'wordpress-hosting', name: 'Хостинг для WordPress', seo: { title: 'Оптимізований хостинг для WordPress', text: 'Наш WordPress хостинг налаштований для максимальної продуктивності та безпеки. Завдяки LiteSpeed Cache та NVMe SSD ваш сайт завантажуватиметься миттєво, що покращить SEO та досвід користувачів.' } },
            { slug: 'joomla-hosting', name: 'Хостинг для Joomla!', seo: { title: 'Професійні рішення для Joomla', text: 'Joomla потребує стабільного та потужного середовища. Ми надаємо оптимізовані конфігурації серверів спеціально для сайтів на Joomla, забезпечуючи високу безпеку та швидку відповідь бази даних.' } },
            { slug: 'prestashop-hosting', name: 'Хостинг для Prestashop', seo: { title: 'Швидкий хостинг для магазинів PrestaShop', text: 'E-commerce сайти потребують швидкості для конвертації відвідувачів у покупців. Наш PrestaShop хостинг включає розширене кешування та спеціалізований захист для вашого бізнесу.' } },
            { slug: 'drupal-hosting', name: 'Хостинг для Drupal', seo: { title: 'Хостинг корпоративного рівня для Drupal', text: 'Drupal потужний, але ресурсомісткий. Наша інфраструктура забезпечує необхідну потужність RAM та CPU для легкої обробки складних Drupal проєктів.' } },
            { slug: 'magento-hosting', name: 'Хостинг для Magento', seo: { title: 'Високопродуктивний хостинг для Magento', text: 'Magento — вибір для великих інтернет-магазинів. Ми пропонуємо виділені ресурси та кешування Varnish, щоб ваш магазин залишався швидким навіть при великому трафіку.' } },
            { slug: 'opencart-hosting', name: 'Хостинг для OpenCart', seo: { title: 'Надійний хостинг для OpenCart', text: 'Легкий у керуванні, швидкий у завантаженні. Наш план для OpenCart розроблений для малого та середнього бізнесу, якому потрібен стабільний магазин без технічних складнощів.' } },
            { slug: 'charity-hosting', name: 'Благодійний хостинг', seo: { title: 'Підтримка неприбуткових організацій', text: 'Ми віримо в допомогу. Наш благодійний хостинг надає неприбутковим організаціям стабільну платформу для поширення їхніх ідей та ефективного управління ініціативами.' } },
          ]
        },
        {
          name: 'Віртуальний хостинг',
          items: [
            { slug: 'cloud-hosting', name: 'Хмарний хостинг', seo: { title: 'Масштабовані послуги хмарного хостингу', text: 'Хмарний хостинг забезпечує неперевершену надійність. Ваш сайт розміщується на кластері серверів, що виключає єдину точку відмови та дає можливість миттєвого масштабування.' } },
            { slug: 'vip-hosting', name: 'VIP-хостинг', seo: { title: 'Ексклюзивний VIP-хостинг', text: 'Для тих, кому потрібно більше, ніж звичайний хостинг. VIP-хостинг пропонує більше ресурсів, пріоритетну підтримку та менш завантажене середовище сервера.' } },
            { slug: 'hosting-with-domain', name: 'Хостинг із доменом', seo: { title: 'Все в одному: хостинг та домен', text: 'Розпочніть свій шлях в онлайні легко. Зареєструйте домен та отримайте якісний хостинг в одному пакеті, керованому з єдиної професійної панелі.' } },
            { slug: 'student-hosting', name: 'Доступний хостинг для студентів', seo: { title: 'Хостинг для навчання та проєктів', text: 'Вивчаєте веб-розробку? Наш план для студентів має доступну ціну, надаючи всі інструменти для створення та тестування ваших перших проєктів.' } },
            { slug: 'reseller-hosting', name: 'Потужний реселер-хостинг', seo: { title: 'Розпочніть власний хостинг-бізнес', text: 'Наш реселер-хостинг дає вам можливість продавати хостинг власним клієнтам. Керуйте багатьма акаунтами через WHM та надавайте преміальний сервіс під своїм брендом.' } },
            { slug: 'overseas-hosting', name: 'Зарубіжний хостинг', seo: { title: 'Розміщуйте сайт ближче до вашої аудиторії', text: 'Виходьте на міжнародні ринки з нашим зарубіжним хостингом. Низька затримка та високошвидкісні з’єднання гарантують комфорт для користувачів у всьому світі.' } },
            { slug: 'ssd-hosting', name: 'Швидкий SSD-хостинг', seo: { title: 'Прискорте сайт за допомогою SSD', text: 'Старі HDD відійшли в минуле. Наш SSD хостинг гарантує, що файли вашого сайту та бази даних обробляються з блискавичною швидкістю.' } },
            { slug: 'trial-hosting', name: 'Хостинг з тестовим періодом', seo: { title: 'Спробуйте наш хостинг безкоштовно', text: 'Впевненість у якості дозволяє нам пропонувати тестовий період. Перевірте нашу швидкість, підтримку та панель керування без жодних зобов’язань.' } },
            { slug: 'blog-hosting', name: 'Хостинг для блогу', seo: { title: 'Поділіться своєю історією', text: 'Використовуєте ви WordPress чи іншу платформу, наш хостинг для блогів забезпечує стабільність, необхідну для зростання вашої аудиторії.' } },
            { slug: 'forum-hosting', name: 'Хостинг для форуму', seo: { title: 'Будуйте спільноту на швидких серверах', text: 'Форуми створюють багато запитів до бази даних. Наш хостинг оптимізовано для таких движків як phpBB або vBulletin для стабільної роботи.' } },
            { slug: 'landing-page-hosting', name: 'Хостинг для Landing Page', seo: { title: 'Швидкий хостинг для маркетингових кампаній', text: 'Кожна секунда важлива для конверсії. Наш хостинг гарантує, що ваші лендінги завантажуватимуться миттєво, максимізуючи вашу віддачу від реклами.' } },
            { slug: 'ecommerce-hosting', name: 'Хостинг для інтернет-магазину', seo: { title: 'Надійне рішення для онлайн-продажів', text: 'Ми забезпечуємо безперебійну роботу вашого магазину 24/7. Безпечні платежі, швидке завантаження товарів та готовність до високих навантажень.' } },
            { slug: 'business-card-hosting', name: 'Хостинг для сайту-візитки', seo: { title: 'Професійний хостинг для сайтів-візиток', text: 'Сайт-візитка — це ваше обличчя в мережі. Ми забезпечуємо надійний хостинг для миттєвого завантаження вашої контактної інформації та портфоліо.' } },
            { slug: 'email-hosting', name: 'Поштовий хостинг', seo: { title: 'Професійна корпоративна пошта', text: 'Створюйте професійні поштові скриньки на власному домені. Наш поштовий хостинг забезпечує високу доставку листів та захист від спаму.' } },
            { slug: 'nvme-hosting', name: 'NVMe хостинг', seo: { title: 'Ультрашвидкий NVMe SSD хостинг', text: 'Розкрийте повний потенціал вашого сайту з NVMe накопичувачами. Прискорте роботу бази даних та доступ до файлів у 3-5 разів порівняно зі звичайними SSD.' } },
          ]
        },
        {
          name: 'Безкоштовний хостинг',
          items: [
            { slug: 'free-php-hosting', name: 'Безкоштовний PHP хостинг', seo: { title: 'Надійний безкоштовний PHP хостинг', text: 'Ідеальний старт для PHP розробників. Отримайте всі необхідні функції, включаючи MySQL та cPanel, безкоштовно для тестування та запуску скриптів.' } },
            { slug: 'free-personal-hosting', name: 'Безкоштовний персональний хостинг', seo: { title: 'Безкоштовний хостинг для особистих проєктів', text: 'Запустіть свій блог або сайт без витрат. Ми надаємо стабільну інфраструктуру та цілодобовий моніторинг навіть для безкоштовних тарифів.' } },
            { slug: 'free-wordpress-hosting', name: 'Безкоштовний WordPress хостинг', seo: { title: 'Оптимізований безкоштовний хостинг для WordPress', text: 'Найпростіший спосіб почати роботу з WordPress. Налаштоване середовище та сучасні NVMe накопичувачі за нульовою вартістю.' } },
            { slug: 'partner-free-hosting', name: 'Партнерський безкоштовний хостинг', seo: { title: 'Безкоштовний хостинг для партнерів', text: 'Ви агентство чи розробник? Приводьте клієнтів до HostPro та отримуйте безкоштовний високопродуктивний хостинг для власних проєктів.' } },
          ]
        }
      ]
    },
    footer: { tagline: 'Сучасний хостинг для сучасних проєктів.', copy: '© 2025 HostPro. Усі права захищені.', cols: { products: 'Продукти', services: 'Послуги', resources: 'Ресурси', legal: 'Юридична інформація' }, links: { pricing: 'Тарифи', faq: 'FAQ', status: 'Статус системи', wpHosting: 'WordPress хостинг', vpsHosting: 'VPS хостинг', dedicated: 'Виділені сервери', resellerHosting: 'Реселер хостинг', laravelHosting: 'Laravel хостинг', phpHosting: 'PHP хостинг', prestashopHosting: 'PrestaShop хостинг', freeHosting: 'Безкоштовний хостинг', kb: 'База знань', blog: 'Блог', about: 'Про нас', reviews: 'Відгуки', contact: 'Контакти', terms: 'Умови використання', privacy: 'Конфіденційність', refund: 'Повернення коштів', hostingTypes: 'Типи хостингу' } },
    ...
    tech: {
      ...
      server: {
        ...
        items: [
          { title: 'LiteSpeed Web Server', desc: 'Значно швидший за Apache, оптимізований для WordPress, PrestaShop, OpenCart, WooCommerce, Laravel та інших.' },
      ...
      email: {
        ...
        items: [
          { title: 'Професійна пошта', desc: 'Створюйте скриньки на власному домені (info@вашдомен.com).' },
          { title: 'Захист від спаму', desc: 'Потужні інструменти SpamExperts та SpamAssassin включені.' },
          { title: 'Webmail / IMAP / POP3', desc: 'Доступ до пошти через браузер або улюблені поштові клієнти.' },
        ],
      },
      dev: {
    ...
    pricing: {
      ...
      plans: [
        { name: 'Personal', desc: 'Ідеально для першого сайту та простого лендінгу', price: 0.99, color: '#6EE7B7', popular: false, extras: ['1 сайт', '1 GB NVMe SSD', '512 MB RAM, 1 CPU 20%', '1 Email акаунт', '1 база даних MySQL', 'Безкоштовний SSL сертифікат', 'Панель керування cPanel', 'Підтримка Node.js', 'Захист від шкідливого ПЗ', 'Стандартні бекапи', 'Базова підтримка', 'Гарантія аптайму 99.9%'] },
        { name: 'Starter', desc: 'Для кількох сайтів і росту онлайн-присутності', price: 4.99, color: '#60A5FA', popular: false, extras: ['до 3 сайтів', '3 GB NVMe SSD', '768 MB RAM, 1 CPU 25%', '3 Email акаунтів', '3 бази даних MySQL', 'Безкоштовний SSL сертифікат', 'Панель керування cPanel', 'Підтримка Node.js', 'Захист від шкідливого ПЗ', 'Стандартні бекапи', 'Базова підтримка', 'Гарантія аптайму 99.9%'] },
        ...
        { name: 'Agency', desc: 'Для інтернет-магазинів та бізнес-агентств', price: 19.99, color: '#FB923C', popular: true, extras: ['до 25 сайтів', '25 GB NVMe SSD', '1.5 GB RAM, 2 CPU 80%', 'Необмежено Email', '25 баз даних MySQL', 'Wildcard SSL сертифікат', 'Панель керування cPanel', 'Прискорювач сайту', 'Підтримка Node.js', 'Захист від шкідливого ПЗ', 'Пріоритетний бекап', 'Пріоритетна підтримка 24/7', 'Гарантія аптайму 99.9%'] },
        { name: 'Agency Pro', desc: 'Для успішних масштабних проєктів і сильних команд', price: 39.99, color: '#F472B6', popular: false, extras: ['Необмежено сайтів', '50 GB NVMe SSD', '2 GB RAM, 2 CPU 120%', 'Необмежено Email', 'Необмежено баз даних MySQL', 'Wildcard SSL сертифікат', 'Виділена IP-адреса', 'Панель керування cPanel', 'Прискорювач сайту', 'Підтримка Node.js', 'Pro захист від шкідливого ПЗ', 'Виділений менеджер', 'VIP підтримка 24/7', 'Гарантія аптайму 99.9%'] },
      ],
      faq: [
        ...
        { q: "Чи допоможете перенести сайт?", a: "Так. Ми безкоштовно перенесемо ваш сайт з іншого хостингу при оформленні будь-якого тарифу — просто напишіть нам після оплати." },
        { q: "Як швидко активується хостинг?", a: "Хостинг активується миттєво після оплати. Дані для входу в панель керування ви одразу отримаєте на email." },
        { q: "Чи є приховані платежі?", a: "Ні. Ціни на сайті — остаточні: SSL-сертифікат, бекапи та захист від шкідливого ПЗ вже включені у вартість." },
        { q: "Чи є гарантія повернення коштів?", a: "Так. Ми надаємо 14-денну гарантію повернення коштів, якщо сервіс вам не підійде." },
        { q: "Що таке cPanel і чи складно нею користуватися?", a: "cPanel — найпопулярніша у світі панель керування хостингом. Вона має простий інтерфейс, тому керувати сайтом зможе навіть новачок." },
        { q: "Де фізично розташовані ваші сервери?", a: "Наші сервери розміщені в сучасному дата-центрі у Варшаві (Польща). Це забезпечує низьку затримку та високу швидкість завантаження для користувачів з України, Польщі, Румунії, Молдови, Угорщини, Словаччини, Чехії, країн Балтії (Латвія, Литва, Естонія), Північної Європи (Фінляндія), а також Німеччини, Італії, Туреччини, Казахстану, Узбекистану та інших країн Європи й Центральної Азії. Дані зберігаються в межах ЄС, що важливо для бізнесу та відповідності європейським вимогам щодо захисту даних." },
      ],
    },
    who: {
    ...
    faq: {
      meta: 'Відповіді на найчастіші питання про хостинг HostPro.', label: 'FAQ', title: 'FAQ', h1p1: 'Часті', h1p2: 'запитання', sub: 'Відповіді на найпоширеніші питання про наш хостинг.', items: [
        { q: "Чи можу я перейти на інший тариф пізніше?", a: "Так. Ви можете змінити тариф у будь-який момент без простою сайту — оплачуєте лише різницю у вартості." },
        { q: "Чи допоможете перенести сайт?", a: "Так. Ми безкоштовно перенесемо ваш сайт з іншого хостингу при оформленні будь-якого тарифу — просто напишіть нам після оплати." },
        { q: "Як швидко активується хостинг?", a: "Хостинг активується миттєво після оплати. Дані для входу в панель керування ви одразу отримаєте на email." },
        { q: "Чи є приховані платежі?", a: "Ні. Ціни на сайті — остаточні: SSL-сертифікат, бекапи та захист від шкідливого ПЗ вже включені у вартість." },
        ...
        { q: "Що таке cPanel і чи складно нею користуватися?", a: "cPanel — найпопулярніша у світі панель керування хостингом. Вона має простий інтерфейс, тому керувати сайтом зможе навіть новачок." },
        { q: "Де фізично розташовані ваші сервери?", a: "Наші сервери розміщені в сучасному дата-центрі у Варшаві (Польща). Це забезпечує низьку затримку та високу швидкість завантаження для користувачів з України, Польщі, Румунії, Молдови, Угорщини, Словаччини, Чехії, країн Балтії (Латвія, Литва, Естонія), Північної Європи (Фінляндія), а також Німеччини, Італії, Туреччини, Казахстану, Узбекистану та інших країн Європи й Центральної Азії. Дані зберігаються в межах ЄС, що важливо для бізнесу та відповідності європейським вимогам щодо захисту даних." },
        { q: 'Що входить до безкоштовного SSL?', a: "Let's Encrypt SSL для кожного домену та субдомену, оновлюється кожні 90 днів. На Agency тарифах — Wildcard SSL." },
        { q: 'Як часто робляться бекапи?', a: 'На тарифах Business та вище — щоденні бекапи зберігаються 7 днів. Відновлення в один клік через cPanel.' },
        { q: 'Чи підтримуєте WordPress?', a: 'Так, повністю. Встановлення в один клік через Softaculous в cPanel. Також WooCommerce, PrestaShop, Joomla, Drupal.' },
      ]
    },
    ...
    freeHosting: {
      meta: 'Безкоштовний хостинг для партнерів — діліться посиланням, приводьте клієнтів та отримайте хостинг для свого сайту безкоштовно.',
      badge: '🎁 Партнерська програма · Free Hosting',
      title1: 'Безкоштовний хостинг',
      title2: 'для наших партнерів',
      sub: 'Зареєструйтесь, отримайте унікальне посилання та залучіть клієнтів. Винагорода — безкоштовний хостинг для вашого сайту, а статистика переходів доступна в системі.',
      ...
      terms: [
        'Для участі потрібно заповнити заявку та отримати реферальне посилання.',
        'Клієнт має зробити замовлення за вашим посиланням на термін від 1 року включно.',
        'Статистика переходів та покупок доступна у вашій партнерській системі.',
      ...
      form: {
        ...
        partnerEmail: 'Контактний Email',
        notes: 'Де плануєте розміщувати посилання? (необов\'язково)',
        submit: 'Надіслати заявку →',
        success: '✅ Заявку відправлено! Ми зв\'яжемося з вами найближчим часом для надання посилання.',
        error: '❌ Щось пішло не так. Спробуйте ще раз або зверніться до підтримки.'
      }
    },
    freePhp: {
  ...
  ru: {
      ...
      categories: [
        {
          name: 'CMS-хостинг',
          items: [
            { slug: 'wordpress-hosting', name: 'Хостинг для WordPress', seo: { title: 'Оптимизированный хостинг для WordPress', text: 'Наш WordPress хостинг настроен для максимальной производительности и безопасности. Благодаря LiteSpeed Cache и NVMe SSD ваш сайт будет загружаться мгновенно, что улучшит SEO и пользовательский опыт.' } },
            { slug: 'joomla-hosting', name: 'Хостинг для Joomla!', seo: { title: 'Профессиональные решения для Joomla', text: 'Joomla требует стабильной и мощной среды. Мы предоставляем оптимизированные конфигурации серверов специально для сайтов на Joomla, обеспечивая высокую безопасность и быстрый ответ базы данных.' } },
            { slug: 'prestashop-hosting', name: 'Хостинг для Prestashop', seo: { title: 'Быстрый хостинг для магазинов PrestaShop', text: 'E-commerce сайты нуждаются в скорости для конвертации посетителей в покупателей. Наш PrestaShop хостинг включает расширенное кэширование и специализированную защиту для вашего бизнеса.' } },
            { slug: 'drupal-hosting', name: 'Хостинг для Drupal', seo: { title: 'Хостинг корпоративного уровня для Drupal', text: 'Drupal мощный, но ресурсоемкий. Наша инфраструктура обеспечивает необходимую мощность RAM и CPU для легкой обработки сложных Drupal проектов.' } },
            { slug: 'magento-hosting', name: 'Хостинг для Magento', seo: { title: 'Высокопроизводительный хостинг для Magento', text: 'Magento — выбор для крупных интернет-магазинов. Мы предлагаем выделенные ресурсы и кэширование Varnish, чтобы ваш магазин оставался быстрым даже при высоком трафике.' } },
            { slug: 'opencart-hosting', name: 'Хостинг для OpenCart', seo: { title: 'Надежный хостинг для OpenCart', text: 'Легкий в управлении, быстрый в загрузке. Наш план для OpenCart разработан для малого и среднего бизнеса, которому нужен стабильный магазин без технических сложностей.' } },
            { slug: 'charity-hosting', name: 'Благотворительный хостинг', seo: { title: 'Поддержка некоммерческих организаций', text: 'Мы верим в помощь. Наш благотворительный хостинг предоставляет НКО стабильную платформу для распространения их идей и эффективного управления инициативами.' } },
          ]
        },
        {
          name: 'Виртуальный хостинг',
          items: [
            { slug: 'cloud-hosting', name: 'Облачный хостинг', seo: { title: 'Масштабируемые услуги облачного хостинга', text: 'Облачный хостинг обеспечивает непревзойденную надежность. Ваш сайт размещается на кластере серверов, что исключает единую точку отказа и дает возможность мгновенного масштабирования.' } },
            { slug: 'vip-hosting', name: 'VIP-хостинг', seo: { title: 'Эксклюзивный VIP-хостинг', text: 'Для тех, кому нужно больше, чем обычный хостинг. VIP-хостинг предлагает больше ресурсов, приоритетную поддержку и менее загруженную среду сервера.' } },
            { slug: 'hosting-with-domain', name: 'Хостинг с доменом', seo: { title: 'Все в одном: хостинг и домен', text: 'Начните свой путь в онлайне легко. Зарегистрируйте домен и получите качественный хостинг в одном пакете, управляемом из единой профессиональной панели.' } },
            { slug: 'student-hosting', name: 'Доступный хостинг для студентов', seo: { title: 'Хостинг для обучения и проектов', text: 'Изучаете веб-разработку? Наш план для студентов имеет доступную цену, предоставляя все инструменты для создания и тестирования ваших первых проектов.' } },
            { slug: 'reseller-hosting', name: 'Мощный реселлер-хостинг', seo: { title: 'Начните собственный хостинг-бизнес', text: 'Наш реселлер-хостинг дает вам возможность продавать хостинг собственным клиентам. Управляйте множеством аккаунтов через WHM и предоставляйте премиальный сервис под своим брендом.' } },
            { slug: 'overseas-hosting', name: 'Зарубежный хостинг', seo: { title: 'Размещайте сайт ближе к вашей аудитории', text: 'Выходите на международные рынки с нашим зарубежным хостингом. Низкая задержка и высокоскоростные соединения гарантируют комфорт для пользователей во всем мире.' } },
            { slug: 'ssd-hosting', name: 'Быстрый SSD-хостинг', seo: { title: 'Ускорьте сайт при помощи SSD', text: 'Старые HDD ушли в прошлое. Наш SSD хостинг гарантирует, что файлы вашего сайта и базы данных обрабатываются с молниеносной скоростью.' } },
            { slug: 'trial-hosting', name: 'Хостинг с тестовым периодом', seo: { title: 'Попробуйте наш хостинг бесплатно', text: 'Уверенность в качестве позволяет нам предлагать тестовый период. Проверьте нашу скорость, поддержку и панель управления без каких-либо обязательств.' } },
            { slug: 'blog-hosting', name: 'Хостинг для блога', seo: { title: 'Поделитесь своей историей', text: 'Используете ли вы WordPress или другую платформу, наш хостинг для блогов обеспечивает стабильность, необходимую для роста вашей аудитории.' } },
            { slug: 'forum-hosting', name: 'Хостинг для форума', seo: { title: 'Стройте сообщество на быстрых серверах', text: 'Форумы создают много запросов к базе данных. Наш хостинг оптимизирован для таких движков как phpBB или vBulletin для стабильной работы.' } },
            { slug: 'landing-page-hosting', name: 'Хостинг для Landing Page', seo: { title: 'Быстрый хостинг для маркетинговых кампаний', text: 'Каждая секунда важна для конверсии. Наш хостинг гарантирует, что ваши лендинги будут загружаться мгновенно, максимизируя вашу отдачу от рекламы.' } },
            { slug: 'ecommerce-hosting', name: 'Хостинг для интернет-магазина', seo: { title: 'Надежное решение для онлайн-продаж', text: 'Мы обеспечиваем бесперебойную работу вашего магазина 24/7. Безопасные платежи, быстрая загрузка товаров и готовность к высоким нагрузкам.' } },
            { slug: 'business-card-hosting', name: 'Хостинг для сайта-визитки', seo: { title: 'Профессиональный хостинг для сайтов-визиток', text: 'Сайт-визитка — это ваше лицо в сети. Мы обеспечиваем надежный хостинг для мгновенной загрузки вашей контактной информации и портфолио.' } },
            { slug: 'email-hosting', name: 'Почтовый хостинг', seo: { title: 'Профессиональная корпоративная почта', text: 'Создавайте профессиональные почтовые ящики на собственном домене. Наш почтовый хостинг обеспечивает высокую доставку писем и защиту от спама.' } },
            { slug: 'nvme-hosting', name: 'NVMe хостинг', seo: { title: 'Ультрабыстрый NVMe SSD хостинг', text: 'Раскройте полный потенциаал вашего сайта с NVMe накопителями. Ускорьте работу базы данных и доступ к файлам в 3-5 раз по сравнению с обычными SSD.' } },
          ]
        },
        {
          name: 'Бесплатный хостинг',
          items: [
            { slug: 'free-php-hosting', name: 'Бесплатный PHP хостинг', seo: { title: 'Надежный бесплатный PHP хостинг', text: 'Идеальный старт для PHP разработчиков. Получите все необходимые функции, включая MySQL и cPanel, бесплатно для тестирования и запуска скриптов.' } },
            { slug: 'free-personal-hosting', name: 'Бесплатный персональный хостинг', seo: { title: 'Бесплатный хостинг для личных проектов', text: 'Запустите свой блог или сайт без затрат. Мы предоставляем стабильную инфраструктуру и круглосуточный мониторинг даже для бесплатных тарифов.' } },
            { slug: 'free-wordpress-hosting', name: 'Бесплатный WordPress хостинг', seo: { title: 'Оптимизированный бесплатный хостинг для WordPress', text: 'Самый простой способ начать работу с WordPress. Настроенная среда и современные NVMe накопители при нулевой стоимости.' } },
            { slug: 'partner-free-hosting', name: 'Партнерский бесплатный хостинг', seo: { title: 'Бесплатный хостинг для партнеров', text: 'Вы агентство или разработчик? Приводите клиентов в HostPro и получайте бесплатный высокопроизводительный хостинг для собственных проектов.' } },
          ]
        }
      ]
    },
    footer: { tagline: 'Современный хостинг для современных проектов.', copy: '© 2025 HostPro. Все права защищены.', cols: { products: 'Продукты', services: 'Услуги', resources: 'Ресурсы', legal: 'Юридическая информация' }, links: { pricing: 'Тарифы', faq: 'FAQ', status: 'Статус системы', wpHosting: 'WordPress хостинг', vpsHosting: 'VPS хостинг', dedicated: 'Выделенные серверы', resellerHosting: 'Реселлер хостинг', laravelHosting: 'Laravel хостинг', phpHosting: 'PHP хостинг', prestashopHosting: 'PrestaShop хостинг', freeHosting: 'Бесплатный хостинг', kb: 'База знаний', blog: 'Блог', about: 'О нас', reviews: 'Отзывы', contact: 'Контакты', terms: 'Условия использования', privacy: 'Конфиденциальность', refund: 'Возврат средств', hostingTypes: 'Типы хостинга' } },
    ...
    tech: {
      ...
      server: {
        ...
        items: [
          { title: 'LiteSpeed Web Server', desc: 'Значительно быстрее Apache, оптимизирован для WordPress, PrestaShop, OpenCart, WooCommerce, Laravel и других.' },
      ...
      email: {
        ...
        items: [
          { title: 'Профессиональная почта', desc: 'Создавайте ящики на собственном домене (info@вашдомен.com).' },
          { title: 'Защита от спама', desc: 'Мощные инструменты SpamExperts и SpamAssassin включены.' },
          { title: 'Webmail / IMAP / POP3', desc: 'Доступ к почте через браузер или любимые почтовые клиенты.' },
        ],
      },
      dev: {
    ...
    pricing: {
      ...
      plans: [
        { name: 'Personal', desc: 'Идеально для первого сайта и простого лендинга', price: 0.99, color: '#6EE7B7', popular: false, extras: ['1 сайт', '1 GB NVMe SSD', '512 MB RAM, 1 CPU 20%', '1 Email аккаунт', '1 база данных MySQL', 'Бесплатный SSL сертификат', 'Панель управления cPanel', 'Поддержка Node.js', 'Защита от вредоносного ПО', 'Стандартные бекапы', 'Базовая поддержка', 'Гарантия аптайма 99.9%'] },
        { name: 'Starter', desc: 'Для нескольких сайтов и роста онлайн-присутствия', price: 4.99, color: '#60A5FA', popular: false, extras: ['до 3 сайтов', '3 GB NVMe SSD', '768 MB RAM, 1 CPU 25%', '3 Email аккаунтов', '3 базы данных MySQL', 'Бесплатный SSL сертификат', 'Панель управления cPanel', 'Поддержка Node.js', 'Защита от вредоносного ПО', 'Стандартные бекапы', 'Базовая поддержка', 'Гарантия аптайма 99.9%'] },
        ...
        { name: 'Agency', desc: 'Для интернет-магазинов и бизнес-агентств', price: 19.99, color: '#FB923C', popular: true, extras: ['до 25 сайтов', '25 GB NVMe SSD', '1.5 GB RAM, 2 CPU 80%', 'Безлимитный Email', '25 баз данных MySQL', 'Wildcard SSL сертификат', 'Панель управления cPanel', 'Ускоритель сайта', 'Поддержка Node.js', 'Защита от вредоносного ПО', 'Приоритетный бекап', 'Приоритетная поддержка 24/7', 'Гарантия аптайма 99.9%'] },
        { name: 'Agency Pro', desc: 'Для успешных масштабных проектов и сильных команд', price: 39.99, color: '#F472B6', popular: false, extras: ['Безлимитно сайтов', '50 GB NVMe SSD', '2 GB RAM, 2 CPU 120%', 'Безлимитный Email', 'Безлимитно баз данных MySQL', 'Wildcard SSL сертификат', 'Выделенный IP-адрес', 'Панель управления cPanel', 'Ускоритель сайта', 'Поддержка Node.js', 'Pro защита от вредоносного ПО', 'Персональный менеджер', 'VIP поддержка 24/7', 'Гарантия аптайма 99.9%'] },
      ],
      faq: [
        ...
        { q: "Поможете перенести сайт?", a: "Да. Мы бесплатно перенесем ваш сайт с другого хостинга при оформлении любого тарифа — просто напишите нам после оплаты." },
        { q: "Как быстро активируется хостинг?", a: "Хостинг активируется мгновенно после оплаты. Данные для входа в панель управления вы сразу получите на email." },
        { q: "Есть ли скрытые платежи?", a: "Нет. Цены на сайте — окончательные: SSL-сертификат, бекапы и защита от вредоносного ПО уже включены в стоимость." },
        { q: "Есть ли гарантия возврата средств?", a: "Да. Мы предоставляем 14-дневную гарантию возврата средств, если сервис вам не подойдет." },
        { q: "Что такое cPanel и сложно ли ею пользоваться?", a: "cPanel — самая популярная в мире панель управления хостингом. Она имеет простой интерфейс, поэтому управлять сайтом сможет даже новичок." },
        { q: "Где физически расположены ваши серверы?", a: "Наши серверы размещены в современном дата-центре в Варшаве (Польша). Это обеспечивает низкую задержку и высокую скорость загрузки для пользователей из Украины, Польши, Румынии, Молдовы, Венгрии, Словакии, Чехии, стран Балтии (Латвия, Литва, Эстония), Северной Европы (Финляндия), а также Германии, Италии, Турции, Казахстана, Узбекистана и других стран Европы и Центральной Азии. Данные хранятся в пределах ЕС, что важно для бизнеса и соответствия европейским требованиям по защите данных." },
      ],
    },
    ...
    faq: {
      meta: 'Ответы на самые частые вопросы о хостинге HostPro.', label: 'FAQ', title: 'FAQ', h1p1: 'Ответы на', h1p2: 'вопросы', sub: 'Ответы на самые распространённые вопросы о нашем хостинге.', items: [
        { q: "Могу ли я перейти на другой тариф позже?", a: "Да. Вы можете изменить тариф в любой момент без простоя сайта — оплачиваете только разницу в стоимости." },
        { q: "Поможете перенести сайт?", a: "Да. Мы бесплатно перенесем ваш сайт с другого хостинга при оформлении любого тарифа — просто напишите нам после оплаты." },
        { q: "Как быстро активируется хостинг?", a: "Хостинг активируется мгновенно после оплаты. Данные для входа в панель управления вы сразу получите на email." },
        { q: "Есть ли скрытые платежи?", a: "Нет. Цены на сайте — окончательные: SSL-сертификат, бекапы и защита от вредоносного ПО уже включены в стоимость." },
        ...
        { q: "Что такое cPanel и сложно ли ею пользоваться?", a: "cPanel — самая популярная в мире панель управления хостингом. Она имеет простой интерфейс, поэтому управлять сайтом сможет даже новичок." },
        { q: "Где физически расположены ваши серверы?", a: "Наши серверы размещены в современном дата-центре в Варшаве (Польша). Это обеспечивает низкую задержку и высокую скорость загрузки для пользователей из Украины, Польши, Румынии, Молдовы, Венгрии, Словакии, Чехии, стран Балтии (Латвия, Литва, Эстония), Северной Европы (Финляндия), а также Германии, Италии, Турции, Казахстана, Узбекистана и других стран Европы и Центральной Азии. Данные хранятся в пределах ЕС, что важно для бизнеса и соответствия европейским требованиям по защите данных." },
        { q: "Что входит в бесплатный SSL?", a: "Let's Encrypt SSL для каждого домена и субдомена, обновляется каждые 90 дней. На тарифах Agency — Wildcard SSL." },
        { q: "Как часто делаются бекапы?", a: "На тарифах Business и выше — ежедневные бекапы хранятся 7 дней. Восстановление одним кликом в cPanel." },
        { q: "Поддерживаете ли WordPress?", a: "Да, полностью. Установка в один клик через Softaculous в cPanel. Также WooCommerce, PrestaShop, Joomla, Drupal." },
      ]
    },
    ...
    freeHosting: {
      meta: 'Бесплатный хостинг для партнеров — делитесь ссылкой, приводите клиентов и получите хостинг для своего сайта бесплатно.',
      badge: '🎁 Партнерская программа · Free Hosting',
      title1: 'Бесплатный хостинг',
      title2: 'для наших партнеров',
      sub: 'Зарегистрируйтесь, получите уникальную ссылку и привлекайте клиентов. Награда — бесплатный хостинг для вашего сайта, а статистика переходов доступна в системе.',
      ...
      terms: [
        'Для участия необходимо заполнить заявку и получить реферальную ссылку.',
        'Клиент должен сделать заказ по вашей ссылке на срок от 1 года включительно.',
        'Статистика переходов и покупок доступна в вашей партнерской системе.',
      ...
      form: {
        ...
        partnerEmail: 'Контактный Email',
        notes: 'Где планируете размещать ссылку? (необязательно)',
        submit: 'Отправить заявку →',
        success: '✅ Заявка отправлена! Мы свяжемся с вами в ближайшее время для предоставления ссылки.',
        error: '❌ Что-то пошло не так. Попробуйте еще раз или обратитесь в поддержку.'
      }
    },
    freePhp: {
