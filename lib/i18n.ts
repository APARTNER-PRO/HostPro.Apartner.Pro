...
export const t = {
  en: {
    ...
    pricing: {
      ...
      faq: [
        { q: "Can I upgrade my plan later?", a: "Yes, you can upgrade at any time without any downtime. You only pay the difference." },
        { q: "Do you help with website migration?", a: "Yes, we migrate your site for free with any hosting plan. Just contact us after ordering." },
        { q: "How fast is hosting activated?", a: "Hosting is activated instantly after payment. You will receive access details via email immediately." },
        { q: "Are there any hidden fees?", a: "No, the prices shown are final. SSL certificates and backups are already included." },
        { q: "Is there a money-back guarantee?", a: "Yes, we offer a 14-day money-back guarantee if you are not satisfied with our service." },
      ],
    },
...
<p>This ensures your live site stays functional while you experiment with new features or designs.</p>`
  ...
  uk: {
    ...
    pricing: {
      ...
      faq: [
        { q: "Чи можу я перейти на інший тариф пізніше?", a: "Так, в будь-який момент без простою сайту. Ви оплачуєте лише різницю у вартості при переході." },
        { q: "Чи допоможете перенести сайт?", a: "Так, безкоштовно переносимо при оформленні будь-якого тарифу. Просто напишіть нам після замовлення." },
        { q: "Як швидко активується хостинг?", a: "Активація відбувається миттєво після оплати. Ви одразу отримаєте дані доступу на email." },
        { q: "Чи є приховані платежі?", a: "Ні, ціни на сайті остаточні. SSL-сертифікат та бекапи вже включені у вартість." },
        { q: "Чи є гарантія повернення коштів?", a: "Так, ми надаємо 14-денну гарантію повернення коштів, якщо ви не будете задоволені сервісом." },
      ],
    },
    who: {
...
<p>Це гарантує стабільну роботу основного сайту, поки ви експериментуєте з новим дизайном чи функціями.</p>`
  ...
  ru: {
    ...
    pricing: {
      ...
      faq: [
        { q: "Могу ли я перейти на другой тариф позже?", a: "Да, в любой момент без простоя сайта. Вы оплачиваете только разницу в стоимости при переходе." },
        { q: "Поможете перенести сайт?", a: "Да, бесплатно переносим при оформлении любого тарифа. Просто напишите нам после заказа." },
        { q: "Как быстро активируется хостинг?", a: "Активация происходит мгновенно после оплаты. Вы сразу получите данные доступа на email." },
        { q: "Есть ли скрытые платежи?", a: "Нет, цены на сайте окончательные. SSL-сертификат и бекапы уже включены в стоимость." },
        { q: "Есть ли гарантия возврата средств?", a: "Да, мы предоставляем 14-дневную гарантию возврата средств, если вы не будете довольны сервисом." },
      ],
    },
