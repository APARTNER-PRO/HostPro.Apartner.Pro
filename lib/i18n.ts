    ...
    pricing: {
      ...
      plans: [
        ...
        { name: 'Starter',    desc: 'For growing projects',             price: 4.99,  color: '#60A5FA', popular: false,
          extras: ['Up to 5 Websites', '5 GB NVMe SSD', '10 Email Accounts', 'Free SSL', 'Backups', 'cPanel'] },
        ...
        { name: 'Agency',     desc: 'For agencies & developers',        price: 19.99, color: '#FB923C', popular: false,
          extras: ['Up to 30 Websites', '30 GB NVMe SSD', 'Unlimited Email', 'Wildcard SSL', 'Priority Backups', 'VIP 24/7 Support'] },
        { name: 'Agency Pro', desc: 'Maximum resources & capabilities', price: 29.99, color: '#F472B6', popular: false,
          extras: ['Unlimited Websites', '50 GB NVMe SSD', 'Unlimited Email', 'Wildcard SSL', 'Unlimited Subdomains', 'Dedicated Manager', 'VIP 24/7 Support'] },
      ],
    },
...
t.uk = {
  ...
  billing: { monthly: 'Щомісяця', quarterly: 'Щоквартально', yearly: 'Щорічно', save10: '−5%', save20: '−10%', monthTerm: '1 місяць', quarterTerm: '3 місяці', yearTerm: '1 рік', payToday: 'Оплатити', today: 'сьогодні', for: 'На' },
  pricing: { title: 'Прозорі тарифи', sub: 'Оберіть план і масштабуйтесь без обмежень', popular: 'Найпопулярніший', mo: '/міс', cta: 'Обрати план', featLabel: 'Включено:', customTitle: 'Не знайшли потрібний тариф?', customSub: 'Напишіть нам — ми підберемо індивідуальне рішення під ваші потреби та бюджет.', customBtn: '✉️ Написати нам',
    plans: [
      ...
      { name: 'Agency Pro', desc: 'Максимум ресурсів і можливостей',     price: 29.99, color: '#F472B6', popular: false, extras: ['Необмежено сайтів', '50 GB NVMe SSD', 'Необмежено Email', 'Wildcard SSL', 'Необмежено субдоменів', 'Виділений менеджер', 'VIP підтримка 24/7'] },
    ],
  },
...
t.ru = {
  ...
  billing: { monthly: 'Ежемесячно', quarterly: 'Ежеквартально', yearly: 'Ежегодно', save10: '−5%', save20: '−10%', monthTerm: '1 месяц', quarterTerm: '3 месяца', yearTerm: '1 год', payToday: 'Оплатить', today: 'сегодня', for: 'На' },
  pricing: { title: 'Прозрачные тарифы', sub: 'Выберите план и масштабируйтесь без ограничений', popular: 'Самый популярный', mo: '/мес', cta: 'Выбрать план', featLabel: 'Включено:', customTitle: 'Не нашли нужный тариф?', customSub: 'Напишите нам — мы подберём индивидуальное решение под ваши нужды и бюджет.', customBtn: '✉️ Написать нам',
    plans: [
      ...
      { name: 'Agency Pro', desc: 'Максимум ресурсов и возможностей',  price: 29.99, color: '#F472B6', popular: false, extras: ['Безлимитно сайтов', '50 GB NVMe SSD', 'Безлимитный Email', 'Wildcard SSL', 'Неограниченные поддомены', 'Персональный менеджер', 'VIP поддержка 24/7'] },
    ],
  },
