    ...
    pricing: {
      ...
      plans: [
        ...
        },
        {
          ...
          extras: ['Up to 15 Websites', '15 GB NVMe SSD', '20 Email Accounts', '15 SQL Databases', 'Free SSL', 'Priority Backups', 'Priority Support', 'Node.js']
        },
        {
          name: 'Agency', desc: 'For agencies & developers', price: 19.99, color: '#FB923C', popular: true,
          extras: ['Up to 25 Websites', '25 GB NVMe SSD', 'Unlimited Email', '25 SQL Databases', 'Wildcard SSL', 'Priority Backups', 'VIP 24/7 Support', 'Node.js']
        },
        {
