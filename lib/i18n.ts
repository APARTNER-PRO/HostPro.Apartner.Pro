    ...
    pricing: {
      ...
      plans: [
        ...
        },
        {
          ...
          extras: ['Up to 5 Websites', '5 GB NVMe SSD', '10 Email Accounts', '5 MySQL Databases', 'Free SSL', 'cPanel', 'Node.js', 'Standard Backups', 'Standard Support']
        },
        {
  ...
  uk: {
    ...
    pricing: {
      ...
      plans: [
        ...
        { name: 'Starter', desc: 'Для зростаючих проєктів', price: 4.99, color: '#60A5FA', popular: false, extras: ['до 5 сайтів', '5 GB NVMe SSD', '10 Email акаунтів', '5 баз даних MySQL', 'Безкоштовний SSL', 'cPanel', 'Node.js', 'Стандартні бекапи', 'Звичайна підтримка'] },
  ...
  ru: {
    ...
    pricing: {
      ...
      plans: [
        ...
        { name: 'Starter', desc: 'Для растущих проектов', price: 4.99, color: '#60A5FA', popular: false, extras: ['до 5 сайтов', '5 GB NVMe SSD', '10 Email аккаунтов', '5 баз данных MySQL', 'Бесплатный SSL', 'cPanel', 'Node.js', 'Стандартные бекапы', 'Обычная поддержка'] },
