    ...
    pricing: {
      ...
      plans: [
        ...
        },
        {
          ...
          extras: ['Up to 15 Websites', '15 GB NVMe SSD', '20 Email Accounts', 'Free SSL', 'Priority Backups', 'Priority Support', 'Node.js']
        },
        {
  ...
  uk: {
    ...
    pricing: {
      ...
      plans: [
        ...
        { name: 'Business', desc: 'Для серйозних проєктів', price: 14.99, color: '#A78BFA', popular: false, extras: ['до 15 сайтів', '15 GB NVMe SSD', '20 Email акаунтів', 'Безкоштовний SSL', 'Пріоритетний бекап', 'Пріоритетна підтримка', 'Node.js'] },
  ...
  ru: {
    ...
    pricing: {
      ...
      plans: [
        ...
        { name: 'Business', desc: 'Для серьёзных проектов', price: 14.99, color: '#A78BFA', popular: false, extras: ['до 15 сайтов', '15 GB NVMe SSD', '20 Email аккаунтов', 'Бесплатный SSL', 'Приоритетный бекап', 'Приоритетная поддержка', 'Node.js'] },
