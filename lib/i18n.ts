...
export const t = {
  en: {
    ...
    pricing: {
      ...
      plans: [
        { name: 'Starter',    desc: 'Perfect for your first website',   price: 3.99,  color: '#6EE7B7', popular: false,
          extras: ['1 Website', '1 GB NVMe SSD', '1 Email Account', 'Free SSL', 'cPanel'] },
        { name: 'Business',   desc: 'For growing projects',             price: 11.99, color: '#60A5FA', popular: true,
          extras: ['Up to 5 Websites', '5 GB NVMe SSD', '10 Email Accounts', 'Free SSL', 'Daily Backups', 'cPanel'] },
        { name: 'Pro',        desc: 'For serious projects',             price: 22.99, color: '#A78BFA', popular: false,
          extras: ['Up to 15 Websites', '15 GB NVMe SSD', 'Unlimited Email', 'Free SSL', 'Priority Backups', 'Priority Support'] },
        { name: 'Agency',     desc: 'For agencies & developers',        price: 45.99, color: '#FB923C', popular: false,
          extras: ['Up to 30 Websites', '30 GB NVMe SSD', 'Unlimited Email', 'Wildcard SSL', 'White-label Ready', 'VIP 24/7 Support'] },
        { name: 'Agency Pro', desc: 'Maximum resources & capabilities', price: 69.99, color: '#F472B6', popular: false,
          extras: ['Unlimited Websites', '50 GB NVMe SSD', 'Unlimited Email', 'Wildcard SSL', 'White-label + Reseller', 'Dedicated Manager', 'VIP 24/7 Support'] },
      ],
    },
    ...
    contact: {
      ...
      channels: [
        { icon: '✉️', title: 'Email',            desc: 'General questions & suggestions',         link: 'hello@hostpro.com',    href: 'mailto:hello@hostpro.com' },
        { icon: '🛠️', title: 'Technical Support', desc: 'Site issues, cPanel, configuration',      link: 'support@hostpro.com',  href: 'mailto:support@hostpro.com' },
        { icon: '💬', title: 'Live Chat',         desc: 'Fastest way to get an answer',            link: 'Open chat →',          href: '#' },
        { icon: '🤝', title: 'Partnerships',      desc: 'White-label, resellers, enterprise',      link: 'partners@hostpro.com', href: 'mailto:partners@hostpro.com' },
      ],
    ...
    terms: {
      ...
      sections: [
        ...
        { title: 'Contact', body: 'Legal questions: legal@hostpro.com' },
      ],
    },
    ...
    privacy: {
      ...
      sections: [
        ...
        { title: 'Your Rights (GDPR)', body: 'You have the right to: access, rectify, erase, restrict processing, object to processing, and data portability. Contact: privacy@hostpro.com' },
        ...
        { title: 'DPO Contact', body: 'privacy@hostpro.com' },
      ],
    },
    ...
    refund: {
      ...
      sections: [
        ...
        { title: 'Refund Process', body: 'Email billing@hostpro.com with your account email. We process within 1 business day; funds return in 3–7 business days.' },
        { title: 'Account Credits', body: 'Instead of a card refund you may choose instant account credits usable for any future service.' },
        { title: 'Disputes', body: 'If you feel a refund was unfairly denied: legal@hostpro.com' },
      ],
    },
...
t.uk = {
  ...
  pricing: { title: 'Прозорі тарифи', sub: 'Оберіть план і масштабуйтесь без обмежень', popular: 'Найпопулярніший', mo: '/міс', cta: 'Обрати план', featLabel: 'Включено:', customTitle: 'Не знайшли потрібний тариф?', customSub: 'Напишіть нам — ми підберемо індивідуальне рішення під ваші потреби та бюджет.', customBtn: '✉️ Написати нам',
    plans: [
      { name: 'Starter',    desc: 'Ідеально для першого сайту',          price: 3.99,  color: '#6EE7B7', popular: false, extras: ['1 сайт', '1 GB NVMe SSD', '1 Email акаунт', 'Безкоштовний SSL', 'cPanel'] },
      { name: 'Business',   desc: 'Для зростаючих проєктів',             price: 11.99, color: '#60A5FA', popular: true,  extras: ['до 5 сайтів', '5 GB NVMe SSD', '10 Email акаунтів', 'Безкоштовний SSL', 'Щоденний бекап', 'cPanel'] },
      { name: 'Pro',        desc: 'Для серйозних проєктів',              price: 22.99, color: '#A78BFA', popular: false, extras: ['до 15 сайтів', '15 GB NVMe SSD', 'Необмежено Email', 'Безкоштовний SSL', 'Пріоритетний бекап', 'Пріоритетна підтримка'] },
      { name: 'Agency',     desc: 'Для агентств і розробників',          price: 45.99, color: '#FB923C', popular: false, extras: ['до 30 сайтів', '30 GB NVMe SSD', 'Необмежено Email', 'Wildcard SSL', 'White-label готовий', 'VIP підтримка 24/7'] },
      { name: 'Agency Pro', desc: 'Максимум ресурсів і можливостей',     price: 69.99, color: '#F472B6', popular: false, extras: ['Необмежено сайтів', '50 GB NVMe SSD', 'Необмежено Email', 'Wildcard SSL', 'White-label + Reseller', 'Виділений менеджер', 'VIP підтримка 24/7'] },
    ],
  },
  ...
  contact: { meta: "Зв'яжіться з командою HostPro — підтримка 24/7, відповідь за 5 хвилин.", label: 'Контакти', title: 'Контакти', h1p1: 'Ми тут,', h1p2: 'щоб допомогти', sub: 'Середній час відповіді — 5 хвилин. Підтримка доступна 24/7.', channels: [{ icon: '✉️', title: 'Email', desc: 'Загальні питання та пропозиції', link: 'hello@hostpro.com', href: 'mailto:hello@hostpro.com' }, { icon: '🛠️', title: 'Технічна підтримка', desc: 'Проблеми з сайтом, cPanel, налаштування', link: 'support@hostpro.com', href: 'mailto:support@hostpro.com' }, { icon: '💬', title: 'Live Chat', desc: 'Найшвидший спосіб отримати відповідь', link: 'Відкрити чат →', href: '#' }, { icon: '🤝', title: 'Партнерство', desc: 'White-label, реселери, корпоративні рішення', link: 'partners@hostpro.com', href: 'mailto:partners@hostpro.com' }], formLabel: "Форма зворотнього зв'язку", formTitle: 'Напишіть нам', nameLbl: "Ім'я", namePh: "Ваше ім'я", emailLbl: 'Email', emailPh: 'your@email.com', topicLbl: 'Тема', msgLbl: 'Повідомлення', msgPh: 'Опишіть ваше питання або проблему...', sendBtn: 'Надіслати повідомлення →', topics: ['Загальне питання', 'Технічна підтримка', 'Білінг та оплата', 'Міграція сайту', 'Партнерство', 'Інше'], success: '✅ Дякуємо! Ми відповімо протягом 5 хвилин.' },
...
t.ru = {
  ...
  pricing: { title: 'Прозрачные тарифы', sub: 'Выберите план и масштабируйтесь без ограничений', popular: 'Самый популярный', mo: '/мес', cta: 'Выбрать план', featLabel: 'Включено:', customTitle: 'Не нашли нужный тариф?', customSub: 'Напишите нам — мы подберём индивидуальное решение под ваши нужды и бюджет.', customBtn: '✉️ Написать нам',
    plans: [
      { name: 'Starter',    desc: 'Идеально для первого сайта',        price: 3.99,  color: '#6EE7B7', popular: false, extras: ['1 сайт', '1 GB NVMe SSD', '1 Email аккаунт', 'Бесплатный SSL', 'cPanel'] },
      { name: 'Business',   desc: 'Для растущих проектов',             price: 11.99, color: '#60A5FA', popular: true,  extras: ['до 5 сайтов', '5 GB NVMe SSD', '10 Email аккаунтов', 'Бесплатный SSL', 'Ежедневный бекап', 'cPanel'] },
      { name: 'Pro',        desc: 'Для серьёзных проектов',            price: 22.99, color: '#A78BFA', popular: false, extras: ['до 15 сайтов', '15 GB NVMe SSD', 'Безлимитный Email', 'Бесплатный SSL', 'Приоритетный бекап', 'Приоритетная поддержка'] },
      { name: 'Agency',     desc: 'Для агентств и разработчиков',      price: 45.99, color: '#FB923C', popular: false, extras: ['до 30 сайтов', '30 GB NVMe SSD', 'Безлимитный Email', 'Wildcard SSL', 'White-label готов', 'VIP поддержка 24/7'] },
      { name: 'Agency Pro', desc: 'Максимум ресурсов и возможностей',  price: 69.99, color: '#F472B6', popular: false, extras: ['Безлимитно сайтов', '50 GB NVMe SSD', 'Безлимитный Email', 'Wildcard SSL', 'White-label + Reseller', 'Персональный менеджер', 'VIP поддержка 24/7'] },
    ],
  },
  ...
  contact: { meta: 'Свяжитесь с командой HostPro — поддержка 24/7, ответ за 5 минут.', label: 'Контакты', title: 'Контакты', h1p1: 'Мы здесь,', h1p2: 'чтобы помочь', sub: 'Среднее время ответа — 5 минут. Поддержка доступна 24/7.', channels: [{ icon: '✉️', title: 'Email', desc: 'Общие вопросы и предложения', link: 'hello@hostpro.com', href: 'mailto:hello@hostpro.com' }, { icon: '🛠️', title: 'Техническая поддержка', desc: 'Проблемы с сайтом, cPanel, настройка', link: 'support@hostpro.com', href: 'mailto:support@hostpro.com' }, { icon: '💬', title: 'Live Chat', desc: 'Самый быстрый способ получить ответ', link: 'Открыть чат →', href: '#' }, { icon: '🤝', title: 'Партнёрство', desc: 'White-label, реселеры, корпоративные решения', link: 'partners@hostpro.com', href: 'mailto:partners@hostpro.com' }], formLabel: 'Форма обратной связи', formTitle: 'Напишите нам', nameLbl: 'Имя', namePh: 'Ваше имя', emailLbl: 'Email', emailPh: 'your@email.com', topicLbl: 'Тема', msgLbl: 'Сообщение', msgPh: 'Опишите ваш вопрос или проблему...', sendBtn: 'Отправить сообщение →', topics: ['Общий вопрос', 'Техническая поддержка', 'Биллинг и оплата', 'Миграция сайта', 'Партнёрство', 'Другое'], success: '✅ Спасибо! Мы ответим в течение 5 минут.' },
