  ...
  en: {
    ...
    pricing: {
      ...
      plans: [
        ...
        { name: 'Starter',    desc: 'For growing projects',             price: 4.99,  color: '#60A5FA', popular: true,
...
t.uk = {
  ...
  pricing: { title: 'Прозорі тарифи', sub: 'Оберіть план і масштабуйтесь без обмежень', popular: 'Найпопулярніший', mo: '/міс', cta: 'Обрати план', featLabel: 'Включено:', customTitle: 'Не знайшли потрібний тариф?', customSub: 'Напишіть нам — ми підберемо індивідуальне рішення під ваші потреби та бюджет.', customBtn: '✉️ Написати нам',
    plans: [
      { name: 'Personal',   desc: 'Ідеально для першого сайту',          price: 1.99,  color: '#6EE7B7', popular: false, extras: ['1 сайт', '1 GB NVMe SSD', '1 Email акаунт', 'Безкоштовний SSL', 'cPanel'] },
      { name: 'Starter',    desc: 'Для зростаючих проєктів',             price: 4.99,  color: '#60A5FA', popular: true,  extras: ['до 5 сайтів', '5 GB NVMe SSD', '10 Email акаунтів', 'Безкоштовний SSL', 'Щоденний бекап', 'cPanel'] },
      ...
      { name: 'Agency Pro', desc: 'Максимум ресурсів і можливостей',     price: 29.99, color: '#F472B6', popular: false, extras: ['Необмежено сайтів', '50 GB NVMe SSD', 'Необмежено Email', 'Wildcard SSL', 'White-label + Reseller', 'Виділений менеджер', 'VIP підтримка 24/7'] },
    ],
  },
...
t.ru = {
  ...
  pricing: { title: 'Прозрачные тарифы', sub: 'Выберите план и масштабируйтесь без ограничений', popular: 'Самый популярный', mo: '/мес', cta: 'Выбрать план', featLabel: 'Включено:', customTitle: 'Не нашли нужный тариф?', customSub: 'Напишите нам — мы подберём индивидуальное решение под ваши нужды и бюджет.', customBtn: '✉️ Написать нам',
    plans: [
      { name: 'Personal',   desc: 'Идеально для первого сайта',        price: 1.99,  color: '#6EE7B7', popular: false, extras: ['1 сайт', '1 GB NVMe SSD', '1 Email аккаунт', 'Бесплатный SSL', 'cPanel'] },
      { name: 'Starter',    desc: 'Для растущих проектов',             price: 4.99,  color: '#60A5FA', popular: true,  extras: ['до 5 сайтов', '5 GB NVMe SSD', '10 Email аккаунтов', 'Бесплатный SSL', 'Ежедневный бекап', 'cPanel'] },
      ...
      { name: 'Agency Pro', desc: 'Максимум ресурсов и возможностей',  price: 29.99, color: '#F472B6', popular: false, extras: ['Безлимитно сайтов', '50 GB NVMe SSD', 'Безлимитный Email', 'Wildcard SSL', 'White-label + Reseller', 'Персональный менеджер', 'VIP поддержка 24/7'] },
    ],
  },
