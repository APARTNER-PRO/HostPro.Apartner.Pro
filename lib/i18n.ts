  ...
  en: {
    ...
    pricing: {
      ...
      plans: [
        ...
        {
          name: 'Agency', desc: 'For online stores and agencies striving for stable sales', price: 19.99, color: '#FB923C', popular: true,
          extras: [
  ...
  uk: {
    ...
    pricing: {
      ...
      plans: [
        ...
        { name: 'Agency', desc: 'Для інтернет-магазинів та агентств, що прагнуть стабільних продажів', price: 19.99, color: '#FB923C', popular: true, extras: ['до 25 сайтів', '25 GB NVMe SSD', '1.5 GB RAM, 2 CPU 80%', 'Необмежено Email', '25 баз даних MySQL', 'Wildcard SSL сертифікат', 'Панель керування cPanel', 'Прискорювач сайту', 'Підтримка Node.js', 'Захист від шкідливого ПЗ', 'Пріоритетний бекап', 'Пріоритетна підтримка 24/7', 'Гарантія аптайму 99.9%'] },
  ...
  ru: {
    ...
    pricing: {
      ...
      plans: [
        ...
        { name: 'Agency', desc: 'Для интернет-магазинов и агентств, стремящихся к стабильным продажам', price: 19.99, color: '#FB923C', popular: true, extras: ['до 25 сайтов', '25 GB NVMe SSD', '1.5 GB RAM, 2 CPU 80%', 'Безлимитный Email', '25 баз данных MySQL', 'Wildcard SSL сертификат', 'Панель управления cPanel', 'Ускоритель сайта', 'Поддержка Node.js', 'Защита от вредоносного ПО', 'Приоритетный бекап', 'Приоритетная поддержка 24/7', 'Гарантия аптайма 99.9%'] },
