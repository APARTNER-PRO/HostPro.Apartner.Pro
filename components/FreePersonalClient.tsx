      ...
      <section style={{ textAlign: 'center', marginBottom: 120 }}>
        <FadeIn>
          <div style={{ background: 'linear-gradient(135deg, rgba(16,185,129,0.1), rgba(5,150,105,0.05))', border: '1px solid rgba(16,185,129,0.2)', borderRadius: 32, padding: 56, maxWidth: 800, margin: '0 auto' }}>
            ...
            <Link href={`/${lang}${T.freePersonal.upgrade.href}`} style={{ display: 'inline-block', padding: '16px 36px', background: 'linear-gradient(135deg, #10B981, #059669)', color: '#fff', borderRadius: 100, textDecoration: 'none', fontWeight: 700, fontSize: 16, boxShadow: '0 10px 30px rgba(16,185,129,0.3)', transition: 'transform .3s ease' }}>
